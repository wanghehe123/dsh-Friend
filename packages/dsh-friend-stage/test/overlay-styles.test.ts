...
describe('float overlay stylesheet injection', () => {
  ...
  it('places grab cursors and the four resize corners in the stylesheet', () => {
    ...
    expect(FRIEND_OVERLAY_CSS).toContain('color-scheme: none')
    ...
    expect(FRIEND_OVERLAY_CSS).toContain('#dsh-friend-float[hidden]')
    expect(FRIEND_OVERLAY_CSS).toContain('display: none !important')
