...
/**
 * Mock of the official tool view chain (`agent → preset → global`).
 *
 * Tools registered on a named scope are invisible to every other scope.
 * A coding-preset assemble therefore only sees the global layer.
 */
