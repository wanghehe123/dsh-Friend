...
/**
 * Serialize work on one absolute path so two writers cannot interleave
 * read-modify-write. Process-local (one dsh host).
 */
 ...
 * the new file, never a torn draft / story.md / MEMORY.md.
 */
